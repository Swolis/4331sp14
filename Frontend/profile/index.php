                ...
                <tbody >
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href = "edit.php" onclick="location.href=this.href+'?id=<?php echo $contact['id'];?>'+'&name='+ename+'&email='+eemail+'&phone='+ephone+'&country='+ecountry+'&rating='+erating+'&opening='+eopening+'&title='+etitle+'&address='+eaddress+'&notes='+enotes"><button type="submit" id="end-editing">Done</button></a>
